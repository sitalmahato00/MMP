...
class SettingsController extends Controller
{
    public function index()
    {
        ...
        return view('student.settings.index', compact('user', 'preferences', 'notificationPreferences', 'activeSessions'));
    }
    ...
    public function updateNotifications(Request $request)
    {
        ...
        $request->validate([
            'email_assignment_alerts' => ['nullable', 'boolean'],
            ...
            'inapp_assignments' => ['nullable', 'boolean'],
        ...
        app(NotificationPreferenceService::class)->saveNotificationPreferences($user, [
            'email_assignment_alerts' => $request->boolean('email_assignment_alerts'),
            ...
            'inapp_assignments' => $request->boolean('inapp_assignments'),
