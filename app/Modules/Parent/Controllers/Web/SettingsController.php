...
class SettingsController extends Controller
{
    ...
    {
        $user = Auth::user()->load(['roles', 'parentProfile.children']);
        ...
        return view('parent.settings.index', compact('user', 'preferences', 'notificationPreferences', 'activeSessions'));
    }
    ...
    public function updateNotifications(Request $request)
    {
        ...
        app(NotificationPreferenceService::class)->saveNotificationPreferences($user, [
            'email_child_alerts' => $request->boolean('email_child_alerts'),
            'email_attendance_alerts' => $request->boolean('email_attendance_alerts'),
            'email_grade_alerts' => $request->boolean('email_grade_alerts'),
            ...
            'inapp_attendance' => $request->boolean('inapp_attendance'),
            'inapp_grades' => $request->boolean('inapp_grades'),
