...
class SettingsController extends Controller
{
    public function index()
    {
        ...
        return view('teacher.settings.index', compact('user', 'preferences', 'notificationPreferences', 'activeSessions'));
    }
    ...
    public function updateNotifications(Request $request)
    {
        ...
        $request->validate([
            'email_class_alerts' => ['nullable', 'boolean'],
        ...
        app(NotificationPreferenceService::class)->saveNotificationPreferences($user, [
            'email_class_alerts' => $request->boolean('email_class_alerts'),
