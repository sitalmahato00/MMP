...
class SettingsController extends Controller
{
    public function index()
    {
        ...
        return view('hod.settings.index', compact('user', 'department', 'preferences', 'activeSessions'));
    }
    ...
    {
        $validated = $request->validate([
            'email_student_alerts' => ['required', 'boolean'],
            'email_attendance_alerts' => ['required', 'boolean'],
            'email_exam_alerts' => ['required', 'boolean'],
            'email_teacher_alerts' => ['required', 'boolean'],
            'email_department_updates' => ['required', 'boolean'],
            'inapp_notices' => ['required', 'boolean'],
            'inapp_comments' => ['required', 'boolean'],
            'inapp_department_updates' => ['required', 'boolean'],
