    ...
    <div class="flex flex-col lg:flex-row gap-6" x-data="{ activeTab: 'profile', hasChanges: false }">
        ...
        <main class="min-w-0 flex-1">
            ...
            <div x-show="activeTab === 'profile'" x-cloak class="space-y-6">
                <form action="{{ route('teacher.settings.profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PATCH')
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div class="mt-4 space-y-2">
                                            <div class="flex items-center justify-between rounded-lg bg-white px-3 py-2 text-xs">
                                                ...
                                                <span class="font-semibold text-slate-900">Teacher</span>
                                            </div>
            ...
            <div x-show="activeTab === 'security'" x-cloak class="space-y-6">
                ...
                <div class="rounded-xl border border-slate-200/80 bg-white shadow-sm">
                    ...
                    <form action="{{ route('teacher.settings.password.update') }}" method="POST" class="p-6">
                        @csrf
                        @method('PATCH')
                ...
                <div class="rounded-xl border border-slate-200/80 bg-white shadow-sm">
                    ...
                    <form action="{{ route('teacher.settings.two-factor.update') }}" method="POST" class="p-6">
                        @csrf
                        @method('PATCH')
                ...
                <div class="rounded-xl border border-slate-200/80 bg-white shadow-sm">
                    ...
                    <div class="border-t border-slate-100 bg-slate-50 px-6 py-4">
                        <form action="{{ route('teacher.settings.logout-all') }}" method="POST" x-data @submit.prevent="
                    ...
                    <div class="rounded-xl border border-slate-200/80 bg-white shadow-sm">
                        ...
                        <div class="divide-y divide-slate-100 p-6">
                            <div class="flex items-center justify-between py-4 first:pt-0 last:pb-0">
                                <div>
                                    <p class="text-sm font-medium text-slate-900">Class Alerts</p>
                                    <p class="mt-0.5 text-xs text-slate-500">Schedule changes and class notifications</p>
                                </div>
                                <label class="relative inline-flex cursor-pointer items-center">
                                    <input type="checkbox" name="email_class_alerts" value="1" checked class="peer sr-only">
                            ...
                            <div class="flex items-center justify-between py-4">
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-slate-500">Assignment submissions and deadlines</p>
                                </div>
                                <label class="relative inline-flex cursor-pointer items-center">
                            ...
                            <div class="flex items-center justify-between py-4">
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-slate-500">Exam schedules and marks entry reminders</p>
                                </div>
                                <label class="relative inline-flex cursor-pointer items-center">
                            ...
                            <div class="flex items-center justify-between py-4">
                                <div>
                                    <p class="text-sm font-medium text-slate-900">Department Updates</p>
                                    <p class="mt-0.5 text-xs text-slate-500">Department announcements and policy changes</p>
                                </div>
                                <label class="relative inline-flex cursor-pointer items-center">
                                    <input type="checkbox" name="email_department_updates" value="1" class="peer sr-only">
                                    <div class="peer h-6 w-11 rounded-full bg-slate-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-slate-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300"></div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center justify-between py-4">
                                <div>
                                    ...
                                    <p class="mt-0.5 text-xs text-slate-500">Student attendance reminders and reports</p>
                                </div>
                                <label class="relative inline-flex cursor-pointer items-center">
            ...
            <div x-show="activeTab === 'danger'" x-cloak class="space-y-6">
                ...
                <div class="overflow-hidden rounded-xl border-2 border-red-200 bg-white shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('teacher.settings.reset-dashboard') }}" method="POST" class="mt-4" x-data @submit.prevent="
                ...
                <div class="overflow-hidden rounded-xl border-2 border-red-200 bg-white shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('teacher.settings.clear-preferences') }}" method="POST" class="mt-4" x-data @submit.prevent="
