...
<div class="space-y-6">
        ...
        <div class="relative px-4 py-4 sm:px-6 sm:py-5 lg:px-8">
            <div class="flex flex-col gap-3 lg:gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-600">Enter and manage student marks</p>
                </div>
            </div>
        </div>
    </section>
    ...
    {{-- Filters --}}
    <x-filter-bar action="{{ route('teacher.marks.index') }}">
        <div>
                        ...
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('teacher.marks.show', $exam) }}" class="inline-flex items-center gap-2 rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-600 transition hover:bg-blue-100">
                                        View
                                    </a>
                                    @if($exam->status !== 'completed')
                                        <a href="{{ route('teacher.marks.fill', [$exam, $exam->subjects->first()]) }}" class="inline-flex items-center gap-2 rounded-lg bg-amber-50 px-3 py-1.5 text-xs font-semibold text-amber-600 transition hover:bg-amber-100">
                                            Fill Marks
                                        </a>
                                    @endif
                                </div>
