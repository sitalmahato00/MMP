...
<x-page-header title="Enroll Student" subtitle="Add a new student to the college system."
               back="{{ route('hod.students.index') }}"/>

<form method="POST" action="{{ route('hod.students.store') }}" enctype="multipart/form-data"
      x-data="{
    ...
    <x-form-section title="Enrollment Details" subtitle="Academic program, semester, and session assignment.">
        ...
        <x-form-row>
            ...
            <x-form-field label="Section" name="section">
                <x-input name="section" :value="old('section')" placeholder="e.g. A"/>
            </x-form-field>
    ...
    <div class="flex items-center gap-3 pb-6">
        ...
        <x-btn href="{{ route('hod.students.index') }}" variant="secondary">Cancel</x-btn>
    </div>
</form>
@endsection
