...
@section('content')
<x-page-header title="Media Library" subtitle="Manage department media files and images."/>
...
<div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="flex gap-2">
        ...
        <button type="button" onclick="document.getElementById('uploadModal').classList.remove('hidden')"
                class="inline-flex items-center gap-2 rounded-xl bg-[#8B0000] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#6d0000]">
            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
