                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-1">
                                    ...
                                    <form action="{{ route('hod.attendance.destroy', $session) }}" method="POST"
                                          onsubmit="return confirm('Delete this attendance session? All attendance records will be permanently removed.')">
                                        @csrf @method('DELETE')
                                        <button type="submit"
