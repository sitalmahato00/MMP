    ...
    <x-form-section title="Content" subtitle="Write the full update and upload attachments if needed.">
        <x-form-row>
            <x-form-field label="Content" name="content" :required="true" span="full">
                <x-textarea name="content" rows="7" :required="true" placeholder="Write the update here...">{{ old('content') }}</x-textarea>
            </x-form-field>
            ...
            <x-form-field label="Additional Gallery Photos & Attachments" name="attachments" span="full">
