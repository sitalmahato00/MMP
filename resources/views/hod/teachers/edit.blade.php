...
<form method="POST" action="{{ route('hod.teachers.update', $teacher) }}" enctype="multipart/form-data" class="space-y-5" 
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <x-bs-date-picker name="dob" :value="old('dob', $teacher->user?->dob ? bsDate($teacher->user->dob, 'Y-m-d') : '')"/>
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="address" rows="2"
                          ...
                          placeholder="Full address">{{ old('address', $teacher->user?->address) }}</textarea>
            </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-slate-500">Department cannot be changed from here</p>
            </div>
            ...
            <div>
                ...
                <x-bs-date-picker name="join_date" :value="old('join_date', $teacher->join_date ? bsDate($teacher->join_date, 'Y-m-d') : '')"/>
            ...
            <div>
                ...
                <select name="is_active"
                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm text-slate-700 focus:border-[#1d4ed8] focus:outline-none focus:ring-2 focus:ring-[#1d4ed8]/20 transition">
                    <option value="1" {{ old('is_active', $teacher->is_active ? '1' : '0') === '1' ? 'selected' : '' }}>Active</option>
                    <option value="0" {{ old('is_active', $teacher->is_active ? '1' : '0') === '0' ? 'selected' : '' }}>Inactive</option>
                </select>
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('hod.teachers.show', $teacher) }}" class="rounded-xl border border-slate-200 px-6 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-50 transition">
            Cancel
        </a>
    </div>
