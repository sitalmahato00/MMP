    ...
    <div class="lg:col-span-2 space-y-4">
        <x-card>
            ...
            <dl class="divide-y divide-gray-50">
                ...
                <x-info-row label="Date of Birth">{{ $user->dob ? \Carbon\Carbon::parse($user->dob)->format('d M Y') : '—' }}</x-info-row>
                ...
                <x-info-row label="Member Since">{{ $user->created_at->format('d M Y') }}</x-info-row>
            </dl>
        </x-card>
    </div>
</div>
