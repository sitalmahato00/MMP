...
<div class="flex flex-wrap items-center justify-between gap-4">
    <div>
        ...
        <p class="mt-0.5 text-sm text-slate-500">Onboard a new faculty member to the system.</p>
    </div>
...
<form method="POST" action="{{ route('admin.teachers.store') }}" enctype="multipart/form-data" class="space-y-5" x-data="{}">
    @csrf
        ...
        <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <input type="password" name="password" required
                       class="w-full rounded-xl border {{ $errors->has('password') ? 'border-red-400 bg-red-50' : 'border-slate-200 bg-slate-50' }} px-3.5 py-2.5 text-sm text-slate-700 focus:border-[#8B0000] focus:outline-none focus:ring-2 focus:ring-[#8B0000]/20 transition"
