                ...
                <div class="lg:col-span-2 space-y-5">
                    <div class="rounded-xl border border-slate-100 bg-slate-50 p-5">
                        ...
                        <dl class="grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
                            ...
                            <div><dt class="text-slate-500">Date of Birth</dt><dd class="mt-0.5 font-semibold text-slate-800">{{ $teacher->user?->dob ? \Carbon\Carbon::parse($teacher->user->dob)->format('d M Y') : '—' }}</dd></div>
                    ...
                    <div class="rounded-xl border border-slate-100 bg-slate-50 p-5">
                        ...
                        <dl class="grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
                            ...
                            <div><dt class="text-slate-500">Join Date</dt><dd class="mt-0.5 font-semibold text-slate-800">{{ $teacher->join_date ? \Carbon\Carbon::parse($teacher->join_date)->format('d M Y') : '—' }}</dd></div>
