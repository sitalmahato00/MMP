                        ...
                        <tr class="group hover:bg-slate-50/60 dark:hover:bg-[#1e3a5f] transition-colors">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    @php
                                        $downloadPath = $notice->attachment ? $notice->attachment : ($notice->attachments->first()?->file_path ?? null);
                                    @endphp
                                    @if($downloadPath)
                                        <a href="{{ asset('storage/' . ltrim($downloadPath, '/')) }}" download
                                           class="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:bg-blue-50 hover:text-blue-600 transition" title="Download attachment">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 10l5 5 5-5M12 15V3"/></svg>
                                        </a>
                                    @endif
                                </div>
                            </td>
