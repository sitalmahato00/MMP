    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            <div class="section-header flex items-center justify-between" style="background-color: #003D82;">
                ...
                <span class="text-blue-200 text-xs">{{ $downloads->count() }} papers</span>
            </div>

            <div class="bg-white border border-gray-200 border-t-0 rounded-b-lg shadow-md">
                @forelse($downloads as $download)
                    <div class="flex items-center gap-4 px-5 py-4 border-b border-gray-100 last:border-0 hover:bg-blue-50 transition-colors group">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="font-semibold text-sm text-gray-900 group-hover:text-[#003D82] transition-colors">{{ $download->title }}</div>
                        ...
                        <a href="{{ $download->file_url }}" download class="flex-shrink-0 flex items-center gap-2 px-4 py-2 text-sm font-bold text-white rounded transition-colors hover:opacity-90" style="background-color: #003D82;">
        ...
        <div class="space-y-6">
            ...
            <div>
                <div class="section-header" style="background-color: #003D82;">ℹ️ About Question Bank</div>
