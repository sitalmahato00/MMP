...
<div class="w-full px-4 md:px-8 xl:px-16 2xl:px-24 mx-auto py-8">
    <div class="section-header mb-6" style="background-color: #8B0000;">🏛️ Our Departments</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        @forelse($departments as $dept)
            <div class="group bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg hover:border-red-200 transition-all">
                ...
                <div class="p-5">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="rounded-md bg-red-50 border border-red-100 px-2 py-0.5 text-[10px] font-bold text-red-800 uppercase tracking-wide">{{ $dept->code }}</span>
                    </div>
                    ...
                    <a href="{{ route('public.department.show', $dept->slug) }}" class="block w-full text-center rounded-lg border-2 border-[#8B0000] bg-white px-4 py-2 text-sm font-bold text-[#8B0000] transition-colors hover:bg-[#8B0000] hover:text-white">
                        View Department →
                    </a>
                </div>
            </div>
