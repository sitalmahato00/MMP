            ...
            <div class="bg-white border border-gray-200 border-t-0" x-data="{ activeCtevtTab: '{{ $activeCtevtTab }}' }">
                ...
                @else
                    ...
                    @forelse($notices as $notice)
                        ...
                        <a href="{{ route('public.notice.show', $notice->slug) }}" class="group flex items-start gap-4 px-5 py-4 border-b border-gray-100 last:border-0 hover:bg-red-50 transition-colors cursor-pointer">
                            <div class="flex-shrink-0 w-12 h-14 text-white flex flex-col items-center justify-center rounded" style="background-color: #8B0000;">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="font-semibold text-gray-900 group-hover:text-red-800 text-sm leading-snug transition-colors">
                                    {{ $notice->title }}
                                </div>
                                <div class="flex items-center gap-2 mt-2 flex-wrap">
                                    ...
                                    @if($notice->attachment)
                                        <span class="text-xs text-red-700 flex items-center gap-1 font-semibold">
