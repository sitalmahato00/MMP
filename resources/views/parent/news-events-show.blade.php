...
<div class="max-w-5xl mx-auto space-y-6">
    <!-- Back Button -->
    <div>
        <a href="{{ route('parent.news-events.index') }}" class="inline-flex items-center text-sm text-slate-600 hover:text-slate-900 transition">
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-3">
                        <span class="inline-flex items-center rounded-lg px-3 py-1 text-xs font-semibold {{ $notice->type === 'event' ? 'bg-amber-100 text-amber-700' : 'bg-blue-100 text-blue-700' }}">
                            <i class="fas {{ $notice->type === 'event' ? 'fa-calendar-alt' : 'fa-newspaper' }} mr-1.5"></i>
                            {{ ucfirst($notice->type) }}
                        </span>
                    </div>
