...
<div class="pt-4 pb-1 px-1"
    ...
    <button type="button"
        ...
        <svg class="h-3 w-3 flex-shrink-0 text-slate-600 transition-transform duration-200" :class="open ? 'rotate-0' : '-rotate-90'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
