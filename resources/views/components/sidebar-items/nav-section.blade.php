...
<div class="pt-4 pb-1 px-1"
    ...
    <button type="button"
        ...
        <p class="text-[10px] font-black uppercase tracking-[0.24em] text-white/40 transition-colors">{{ $label }}</p>
        <svg class="h-3.5 w-3.5 flex-shrink-0 text-white/30 transition-transform duration-200" :class="open ? 'rotate-0' : '-rotate-90'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
