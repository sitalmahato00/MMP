...
<header class="fixed inset-x-0 top-0 z-40 flex h-16 items-center justify-between gap-4 px-4 sm:px-5 lg:px-6"
    ...
    <div class="flex items-center gap-1 sm:gap-2 flex-shrink-0">
        ...
        <!-- Divider -->
        <span class="hidden lg:block h-5 w-px mx-1" style="background-color: rgba(255,255,255,0.15);"></span>

        <!-- Language selector -->
        <div class="hidden sm:flex items-center gap-1 rounded px-2 py-1.5 text-xs text-blue-200 transition-colors hover:bg-white/10 hover:text-white cursor-pointer">
